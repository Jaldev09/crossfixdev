...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<!-- Spam Trap -->
			<div style="<?php echo ( ( is_rtl() ) ? 'right' : 'left' ); ?>: -999em; position: absolute;"><label for="trap"><?php esc_html_e( 'Anti-spam', 'yolo-motor' ); ?></label><input type="text" name="email_2" id="trap" tabindex="-1" /></div>
			...
			<p class="form-row">
				...
				<input type="submit" class="button" name="register" value="<?php esc_attr_e( 'Register', 'yolo-motor' ); ?>" />
			</p>
