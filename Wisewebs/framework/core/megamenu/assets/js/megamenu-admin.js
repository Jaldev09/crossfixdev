...
jQuery( function( $ ) { 
	...
	$(document).click(function() {
	    // $('.mega-entry').hide('fast');
	    // $('.mega-list-icon').hide('fast');
	});
	$(document).on('click', '.yolo-icon .select_icon', function(event) {
	...
	$(document).ready(function() {
		...
		$('.yolo-icon .select_color').each(function(){
	...
	$(document).on('click', '.yolo-icon .select_color', function(event) {
		event.stopPropagation();
		event.preventDefault();
