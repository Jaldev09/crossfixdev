...
if (!function_exists('yolo_admin_enqueue_scripts')) {
	...
	function yolo_admin_enqueue_scripts() {
		...
		// Enqueue CSS
		wp_enqueue_style( 'admin-meta-box', get_template_directory_uri() . '/admin/assets/css/meta-box.css', false, '1.0.0' );
        wp_enqueue_style( 'admin-template', get_template_directory_uri() . '/admin/assets/css/template.css', false, '1.0.0' );
...
if (!function_exists('yolo_current_page_url')) {
    function yolo_current_page_url() {
        ...
        $pageURL .= "://";
        if ( true !== empty( $_SERVER["SERVER_PORT"] ) && $_SERVER["SERVER_PORT"] != "80" ) {
