            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type'     => 'slider',
                        'title'    => esc_html__( 'Site Width (%)', 'yolo-motor' ),
                        'subtitle' => esc_html__( 'Set the site width of body', 'yolo-motor' ),
                        'default'  => '90',
                        "min"      => 60,
                        "step"     => 1,
                        "max"      => 100,
                    ...
                    array(
                        ...
                        'type'     => 'slider',
                        'title'    => esc_html__( 'Site Max Width (px)', 'yolo-motor' ),
                        'subtitle' => esc_html__( 'Set the site max width of body', 'yolo-motor' ),
                        'default'  => '1200',
                        "min"      => 980,
                        "step"     => 10,
                        "max"      => 1600,
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'       => 'link_color',
                        'type'     => 'link_color',
                        'title'    => esc_html__( 'Link Color', 'yolo-motor' ),
                        'subtitle' => esc_html__( 'Link Color.', 'yolo-motor' ),
                        'default'  => array(
                            'regular'  => '#ffb535', // blue
                            'hover'    => '#ffb535', // red
                            'active'   => '#ffb535',  // purple
                        ),
                    ),
