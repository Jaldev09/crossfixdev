...
function yolo_register_meta_boxes() {
	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
			...
			array(
				...
				'name'  => esc_html__( 'Logo height', 'yolo-motor' ),
				'desc'  => esc_html__( 'Logo height. Insert number only (empty to set default value)', 'yolo-motor' ),
				'type'  => 'text',
				'sdt'   => '',
			),
	...
	$meta_boxes[] = array(
		...
		'title'      => esc_html__( 'Header Mobile', 'yolo-motor' ),
		'post_types' => array('post', 'page',  'yolo_portfolio','product'),
		'tab'        => true,
		'fields'     => array(
			array(
				'name'       => esc_html__( 'Header Mobile Layout', 'yolo-motor' ),
				'id'         => $prefix . 'mobile_header_layout',
				'type'       => 'image_set',
				'allowClear' => true,
				'std'        => '',
				'options'    => array(
					'header-mobile-1'	    => get_template_directory_uri().'/assets/images/theme-options/header-mobile-layout-1.jpg',
					'header-mobile-4'	    => get_template_directory_uri().'/assets/images/theme-options/header-mobile-layout-4.jpg',
					'header-mobile-3'	    => get_template_directory_uri().'/assets/images/theme-options/header-mobile-layout-3.jpg',
					'header-mobile-5'	    => get_template_directory_uri().'/assets/images/theme-options/header-mobile-layout-5.jpg',
					'header-mobile-2'	    => get_template_directory_uri().'/assets/images/theme-options/header-mobile-layout-2.jpg',
				)
			),
			array(
				'id'      => $prefix . 'mobile_header_menu_drop',
				'name'    => esc_html__( 'Menu Drop Type', 'yolo-motor' ),
				'type'    => 'button_set',
				'std'     => '-1',
				'options' => array(
					'-1'        => esc_html__( 'Default', 'yolo-motor' ),
			...
			array(
				'name'    => esc_html__( 'Header mobile sticky', 'yolo-motor' ),
			...
			array(
				'name'    => esc_html__( 'Mobile Header Search Box', 'yolo-motor' ),
			...
			array(
				'name'    => esc_html__( 'Mobile Header Shopping Cart', 'yolo-motor' ),
...
function yolo_load_rw_custom_fields() {
	require_once get_template_directory() . '/framework/ct_plugins/meta-box/custom-fields/footer.php';
	require_once get_template_directory() . '/framework/ct_plugins/meta-box/custom-fields/button-set.php';
	require_once get_template_directory() . '/framework/ct_plugins/meta-box/custom-fields/image-set.php';
	require_once get_template_directory() . '/framework/ct_plugins/meta-box/custom-fields/checkbox-advanced.php';
	require_once get_template_directory() . '/framework/ct_plugins/meta-box/custom-fields/sorter.php';
}
