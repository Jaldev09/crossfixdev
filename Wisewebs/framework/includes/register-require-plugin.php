...
add_action( 'tgmpa_register', 'yolo_register_required_plugins' );
/**
 ...
 */
function yolo_register_required_plugins() {
    /*
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Yolo Motor Framework', // The plugin name
            'slug'               => 'motor-framework', // The plugin slug (typically the folder name)
            'source'             => 'http://demo.yolotheme.com/theme-plugins/motor-framework.zip', // The plugin source
        ...
        array(
            ...
            'source'             => 'http://demo.yolotheme.com/theme-plugins/revslider.zip', // The plugin source
            'required'           => true, // If false, the plugin is only 'recommended' instead of required
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'       => '', // If set, overrides default API URL and points to an external URL
        ...
        array(
            ...
            'source'             => 'http://demo.yolotheme.com/theme-plugins/js_composer.zip', // The plugin source
            'required'           => true, // If false, the plugin is only 'recommended' instead of required
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'       => '', // If set, overrides default API URL and points to an external URL
        ...
        array(
            ...
            'source'             => 'http://demo.yolotheme.com/theme-plugins/wp-modal-login.zip', // The plugin source
            'required'           => true, // If false, the plugin is only 'recommended' instead of required
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'       => '', // If set, overrides default API URL and points to an external URL
