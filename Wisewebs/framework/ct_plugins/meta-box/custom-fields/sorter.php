...
if ( ! class_exists( 'RWMB_Sorter_Field' ) )
{
	class RWMB_Sorter_Field extends RWMB_Field
	{
		...
		{
			wp_enqueue_style( 'rwmb-sorter', get_template_directory_uri(). '/framework/ct_plugins/meta-box/custom-fields/assets/css/sorter.css', array() );
			wp_enqueue_script( 'rwmb-sorter', get_template_directory_uri(). '/framework/ct_plugins/meta-box/custom-fields/assets/js/sorter.js', array() );
		}
		/**
		 * Get field HTML
		 *
