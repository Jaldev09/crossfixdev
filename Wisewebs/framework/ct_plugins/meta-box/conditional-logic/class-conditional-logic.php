<?php
class Yolo_MB_Conditional_Logic
{
	...
	public function enqueue( $hook )
	{
		...
		wp_register_script( 'conditional-logic', get_template_directory_uri(). '/framework/ct_plugins/meta-box/conditional-logic/assets/js/conditional-logic.js', array(), '1.0.0', true );
