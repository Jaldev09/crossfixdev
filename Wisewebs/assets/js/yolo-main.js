...
(function ($) {
    ...
    YOLO.woocommerce = {
            ...
            $('.product-quick-view').on('click', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        ...
                        // Re-initialize Bootstrap tooltips so they work on the new content...
                        $( '[data-toggle="tooltip"]' ).tooltip();
                    },
                    error: function (html) {
                        alert(2);
        ...
        masonryLayout : function() {
            var $product_masonry = $('.product-listing'); // parent element of .item
        ...
        // products_creative_slider: function() {
        //     jQuery('.yolo-sh-slider .yolo-slider').each(function(){
        ...
        //     });
        // },
        // productsCreative: function() {
        //     YOLO.woocommerce.products_creative_slider();
        
        //     jQuery('.products-creative-list-cat li:first-child a').addClass('active');

        //     jQuery('.products-creative-list-cat li a').on('click',function(event) {
        //         event.preventDefault();
        //         var $parent      = jQuery(this).closest('.products-creative-list-cat');
        //         var $parent_wrap = jQuery(this).closest('.shortcode-product-wrap');
        //         var $this        = jQuery(this);
        ...
        //             var $height = $parent_wrap.find('.products-creative').height();
        //             $parent_wrap.find('.products-creative').css('min-height',$height+'px');

        //             var $cat_id        = jQuery(this).data('id');
        //             var $limit         = jQuery(this).data('limit');
        //             var $product_style = jQuery(this).data('product-style');
        //             var $action_disable = jQuery(this).data('action-disable');
        //             var $action_tooltip = jQuery(this).data('action-tooltip');

        //             jQuery.ajax({
        //                 url: yolo_framework_ajax_url,
        //                 type: 'POST',
        //                 data: ({
        //                     action: 'yolo_products_creative_ajax',
        //                     catid: $cat_id,
        //                     limit: $limit,
        ...
        //                         $parent_wrap.find('.products-creative').css('min-height','inherit');
        //                         $parent_wrap.find('.products-creative-tab').html(data).find('.product-item-wrap').css('opacity',0).animate({opacity: 1},500);
        //                         YOLO.woocommerce.products_creative_slider();
        //                         YOLO.woocommerce.compare();
        //                         YOLO.woocommerce.quickView();
        //                     }
        ...
        //         } else {
        //             $parent_wrap.find('.products-creative-tab').html('');
        //             var $data_value = jQuery(this).attr('data-value');
        //             $parent_wrap.find('.products-creative-tab').html($data_value).find('.product-item-wrap').css('opacity',0).animate({opacity: 1},500);
        //             YOLO.woocommerce.products_creative_slider();
