...
if (!in_array($layout_style, array('full','container','container-fluid'))) {
	...
	if (($layout_style === '') || ($layout_style == '-1')) {
		$layout_style = $yolo_options['single_blog_layout'] ? $yolo_options['single_blog_layout'] : 'container';
	}
}
...
if (!in_array($sidebar, array('none','left','right','both'))) {
	...
	if (($sidebar === '') || ($sidebar == '-1')) {
		$sidebar = $yolo_options['single_blog_sidebar'] ? $yolo_options['single_blog_sidebar'] : 'right';
	}
}
