...
$header_class = array('yolo-main-header', 'header-3', 'header-desktop-wrapper');
					...
					<?php if (has_nav_menu('primary')) : ?>
						<div id="primary-menu" class="menu-wrapper">
							...
							$arg_menu = array(
								...
								'menu_class'     => 'yolo-main-menu nav-collapse navbar-nav' . ($header_nav_separate == '1' ? ' nav-separate' : ''),
